...
class TopJobPost with ChangeNotifier {
  Future<void> applyJob(String employeeId, String jobId) async {
    List<Post> dataList = [];
    try {
      var envelop = '''<?xml version="1.0" encoding="utf-8"?>
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <SaveJobAppliedByEmployeeID xmlns="http://tempuri.org/">
      <id>$employeeId</id>
      <job_id>$jobId</job_id>
      <sign>${Constants.sign}</sign>
    </SaveJobAppliedByEmployeeID>
  </soap:Body>
</soap:Envelope>''';
      ...
      await http
        ...
        headers: {
          ...
          "SOAPAction": "http://tempuri.org/SaveJobAppliedByEmployeeID",
          "Host": "43.228.125.24"
        },
        ...
        var responseDataList = parsedXml
            .findAllElements('SaveJobAppliedByEmployeeIDResult')
            .first
            .children
            .first;
